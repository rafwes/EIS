...
PooledResultsSeparated <- stargazer(Weekly4LagInst1, Weekly4LagInst2, Weekly4LagInst3, title="Estimates of the EIS", column.labels = c("2004-2006", "2007-2008", "2009-2014"), dep.var.labels = "$\\Delta c_{t+4}$", covariate.labels = "$r_{t+4}$", omit = "month", out="EIS/Output/PooledResultsSeparated.tex", label="PooledResultsSeparated", no.space=TRUE)
...
PooledResultsAll <- stargazer(Weekly4LagInstAll, title="Estimates of the EIS", omit = "month", out="EIS/Output/PooledResultsAll.tex", label="PooledResultsAll", no.space=TRUE)
