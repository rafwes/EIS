...
rates_log_avg_wkly <- 
  ...
  summarise(AVG_INDEX_TB = median(INDEX_TB),
            AVG_INDEX_ST = median(INDEX_ST),
            AVG_INDEX_DY = median(INDEX_DY),
            AVG_INDEX_CPI_NE = median(INDEX_CPI_NE),
            AVG_INDEX_CPI_MW = median(INDEX_CPI_MW),
            AVG_INDEX_CPI_SO = median(INDEX_CPI_SO),
            AVG_INDEX_CPI_WE = median(INDEX_CPI_WE),
            AVG_INDEX_CPI_DS_NE = median(INDEX_CPI_DS_NE),
            AVG_INDEX_CPI_DS_MW = median(INDEX_CPI_DS_MW),
            AVG_INDEX_CPI_DS_SO = median(INDEX_CPI_DS_SO),
            AVG_INDEX_CPI_DS_WE = median(INDEX_CPI_DS_WE),
            AVG_INDEX_TB_DEF_NE = median(INDEX_TB_DEF_NE),
            AVG_INDEX_TB_DEF_MW = median(INDEX_TB_DEF_MW),
            AVG_INDEX_TB_DEF_SO = median(INDEX_TB_DEF_SO),
            AVG_INDEX_TB_DEF_WE = median(INDEX_TB_DEF_WE),
            AVG_INDEX_ST_DEF_NE = median(INDEX_ST_DEF_NE),
            AVG_INDEX_ST_DEF_MW = median(INDEX_ST_DEF_MW),
            AVG_INDEX_ST_DEF_SO = median(INDEX_ST_DEF_SO),
            AVG_INDEX_ST_DEF_WE = median(INDEX_ST_DEF_WE),
            AVG_INDEX_TB_DS_DEF_NE = median(INDEX_TB_DS_DEF_NE),
            AVG_INDEX_TB_DS_DEF_MW = median(INDEX_TB_DS_DEF_MW),
            AVG_INDEX_TB_DS_DEF_SO = median(INDEX_TB_DS_DEF_SO),
            AVG_INDEX_TB_DS_DEF_WE = median(INDEX_TB_DS_DEF_WE),
            AVG_INDEX_ST_DS_DEF_NE = median(INDEX_ST_DS_DEF_NE),
            AVG_INDEX_ST_DS_DEF_MW = median(INDEX_ST_DS_DEF_MW),
            AVG_INDEX_ST_DS_DEF_SO = median(INDEX_ST_DS_DEF_SO),
            AVG_INDEX_ST_DS_DEF_WE = median(INDEX_ST_DS_DEF_WE)) %>%
  ungroup() %>% 
  arrange(ISOWEEK) %>% 
...
estimation_data_1y <-
  bind_rows(YearlyEstimationData(consumption_ds_def_ne),
            YearlyEstimationData(consumption_ds_def_mw),
            YearlyEstimationData(consumption_ds_def_so),
            YearlyEstimationData(consumption_ds_def_we)) %>% 
  arrange(HOUSEHOLD,DATE)
